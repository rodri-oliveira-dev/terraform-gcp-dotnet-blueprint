variable "direct_vpc" {
  ...
  description = "Optional Direct VPC egress configuration. When null, the job remains network-agnostic. Network and subnetwork should be names from the target VPC; egress defaults to PRIVATE_RANGES_ONLY."
  default     = null
  nullable    = true

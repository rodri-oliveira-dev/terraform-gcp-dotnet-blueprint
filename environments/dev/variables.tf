...
variable "enable_workloads" {
  type        = bool
  description = "Whether request-serving services, Pub/Sub delivery, the batch job, and its scheduler are created. Keep false during the foundation/secret bootstrap phase."
  default     = false
}

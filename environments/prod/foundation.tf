...
module "api_identity" {
  ...
  description  = "Production runtime identity for the request-serving API."
...
module "worker_identity" {
  ...
  description  = "Production runtime identity for the Pub/Sub worker service."
...
module "batch_identity" {
  ...
  description  = "Production runtime identity for the finite Cloud Run batch job."
...
resource "google_service_account" "pubsub_push" {
  ...
  description  = "Production transport identity used only by Pub/Sub authenticated push delivery."
...
resource "google_service_account" "scheduler" {
  ...
  description  = "Production trigger identity used only by Cloud Scheduler to execute the batch job."
